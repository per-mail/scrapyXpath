#https://www.youtube.com/watch?v=AeddCkkyUFA
# это старый вариант парсера без бота. В этом проекте этот код не работает
...
def collect_data(city_code='2398'):
    ...
    with open(f'{city}_{cur_time}.csv', 'w', encoding="utf_8_sig") as file:
